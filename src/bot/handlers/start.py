...
async def cmd_start(
    ...
    if existing_lead:
        ...
        name = (getattr(existing_lead, "name", "") or "").strip()
        if name:
            welcome_text = (
        ...
        intro_text = (
            "Добрый день! 👋\n\n"
            "Меня зовут бот юридической фирмы SOLIS Partners.\n\n"
            "⚖️ Кто мы:\n"
            "Мы — команда юристов, специализирующихся "
        ...
        catalog_text = (
            f"📂 У нас {guide_count} гайдов по актуальным "
            "юридическим темам.\n\n"
            "Выберите интересующую тему — и я отправлю вам PDF "
            "прямо сюда, в чат:"
        )
